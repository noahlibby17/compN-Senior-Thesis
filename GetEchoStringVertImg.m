function [string, RT] = GetEchoStringVertImg(windowPtr, msg, x, y, imagetexture, img_loc, textColor, bgColor, useKbCheck, varargin)
% string = GetEchoString(window, msg, x, y, imagetexture, [textColor], [bgColor], [useKbCheck=0], [deviceIndex], [untilTime=inf], [KbCheck args...])
%
%
...
%     fprintf('String = %s\n', string);
    ...
    Screen('DrawTexture', windowPtr, imagetexture, [], img_loc);
