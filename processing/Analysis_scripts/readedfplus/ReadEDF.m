...
f1=find(cellfun('isempty', regexp(header.labels, 'Marker', 'once'))==0); % Channels number with the EDF Annotations
f2=find(cellfun('isempty', regexp(header.labels, 'Marker', 'once'))==0); % Channels number with the EDF Annotations
f=[f1(:); f2(:)];
